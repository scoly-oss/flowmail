export function getSignature(): string {
  return `<table cellpadding="0" cellspacing="0" border="0" style="font-family: 'Trebuchet MS', Arial, sans-serif; border-collapse: collapse; margin-top: 20px;">
  <tr>
    <td style="padding-bottom: 12px;">
      <table cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;">
        <tr>
          <td style="width: 4px; background: linear-gradient(180deg, #e8842c, #F5A623); border-radius: 2px;"></td>
          <td style="padding-left: 14px;">
            <table cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;">
              <tr>
                <td style="font-size: 17px; font-weight: 700; color: #1e2d3d; font-family: 'Trebuchet MS', Arial, sans-serif; padding-bottom: 1px;">Sofiane Coly</td>
              </tr>
              <tr>
  ...
  <tr>
    <td style="border-top: 1px solid #e5e7eb; padding-top: 10px;">
      <table cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;">
        ...
        <tr>
          <td style="font-size: 12px; color: #5a6a7a; font-family: 'Trebuchet MS', Arial, sans-serif; padding-bottom: 10px;">
            65 rue Jacques-Louis H&eacute;non, Lyon
          </td>
        </tr>
        <tr>
          <td>
